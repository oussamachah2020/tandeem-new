        ...
        <div className="flex flex-col gap-3">
          <DetailsTable>
            <DetailsSection title={label.information}>
              <DetailsRow title={label.companyName}>{customer.name}</DetailsRow>
              <DetailsRow title={label.address}>{customer.address}</DetailsRow>
            ...
            <DetailsSection title={label.conditions}>
              ...
              <DetailsRow title={label.totalEmployees}>
                {customer._count.employees}
              </DetailsRow>
            </DetailsSection>
