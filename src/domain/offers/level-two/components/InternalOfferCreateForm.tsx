...
export const InternalOfferCreateForm: FC<Props> = ({customer}) => {
    ...
    return (
      ...
      >
            ...
            <div className="border p-3 rounded-lg">
              <div className="flex items-center gap-2 mb-2">
                <input
                  ...
                  checked={useDiscount}
                  onChange={(event) =>
                    setUseDiscount(event.currentTarget.value as any)
                  }
                />
        ...
        <button className="w-full bg-secondary text-white flex justify-center items-center gap-4 rounded-lg py-3 hover:brightness-95 transition duration-200">
